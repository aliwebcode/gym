                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="subscription_category_id" id="subscription_category_id">
                                        ...
                                        @foreach($subscription_categories as $category)
                                            <option value="{{ $category->id }}" {{ (old('subscription_category_id') == $category->id ? "selected" : "") }}>{{ $category->name_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control" name="duration" id="duration"  value="{{ old('duration') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
