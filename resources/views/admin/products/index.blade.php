                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">
                            Products
                            <a href="{{ route('admin.products.create') }}" class="btn btn-success btn-xs" style="margin-left: 5px">New</a>
                        </h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="javascript:void(0);" onclick="if (confirm('Are you sure to delete this record?')) { document.getElementById('delete-form-{{ $product->id }}').submit(); } else { return false; }" class="btn btn-danger btn-sm">
